...
--
-- Host: localhost:3306
-- Generation Time: Mar 20, 2026 at 03:03 PM
...
(37, '18', 2, 'B', '3 BHK Flat', '2026-03-20 06:29:49');
...
(3, '3 BHK Flat', '3000.00', '1500.00', '2026-01-19 17:00:46', '2026-03-20 07:31:45');
...
CREATE TABLE `users` (
  ...
  `role` enum('admin','cashier','user','security_guard') CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci DEFAULT NULL,
