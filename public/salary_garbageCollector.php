...
<head>
    ...
    <title>Garbage Collector Payroll</title>
    ...
    <div class="main-wrapper">
        ...
        <main id="main-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h1 class="fw-800 m-0">Garbage Collector Payroll</h1>
                <div class="col-6 text-end">
                    <a href="<?= BASE_URL ?>garbageCollector.php" class="btn btn-brand shadow-sm">
                        <i class="fa fa-eye me-1"></i> Garbage Staffs
                    </a>
                </div>
            </div>
            ...
            <div class="data-card shadow-sm border-0">
                <div class="table-responsive">
                    <table id="garbage-salary-table" class="table table-hover w-100">
                        <thead>
                            <tr>
                                <th>Month / Year</th>
                                <th>Staff Name</th>
