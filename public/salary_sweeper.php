...
<body>
        ...
        <main id="main-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <div class="col-6 text-end">
                    <a href="<?= BASE_URL ?>sweeper.php" class="btn btn-brand shadow-sm">
                        <i class="fa fa-eye me-1"></i> Sweeper Staffs
                    </a>
                </div>
            </div>
            ...
            <div class="data-card shadow-sm border-0">
                <div class="table-responsive">
                    <table id="sweeper-salary-table" class="table table-hover w-100">
                        <thead>
                            <tr>
                                <th>Month / Year</th>
                                <th>Staff Name</th>
    ...
    <!-- PAY CONFIRM MODAL (SAME AS SECURITY) -->
    ...
    <script>
        $(function() {
            ...
            let selectedSweeperId = null;

            // SERVER SIDE DATATABLE (MATCHED WITH SECURITY UI)
            let table = $('#sweeper-salary-table').DataTable({
                ...
                ajax: {
                    ...
                    type: "POST",
                    data: function(d) {
                        d.action = "fetch_sweeper_salary"; // IMPORTANT
