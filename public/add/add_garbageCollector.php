...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        if ($stmt->execute([$name, $mobile, $dob, $gender, $shift, $joiningDate, $address, $salary])) {
            ...
            flash_set('err', 'Database error! Garbage collector not added.');
            header('Location: ' . BASE_URL . 'add/add_garbageCollector.php');
            exit();
        }
    }
}
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post" novalidate>
                        ...
                        <button type="submit" class="btn btn-primary">Add Garbage Collector</button>

                        <a href="<?= BASE_URL ?>garbageCollector.php" class="btn btn-secondary mx-2">Back</a>
                    </form>
                </div>
